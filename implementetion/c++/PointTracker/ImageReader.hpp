...
public:
	...
	void read_pair_image(cv::Mat& img_1, cv::Mat& img_2, const size_t index_image);
};
...
ImageReader::read_pair_image(cv::Mat& img_1, cv::Mat& img_2, const size_t index_image)
{
	...
	img_1 = cv::imread(image_1_path, cv::IMREAD_GRAYSCALE);
	img_2 = cv::imread(image_2_path, cv::IMREAD_GRAYSCALE);
